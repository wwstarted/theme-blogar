                ...
                <div class="footer-top-social">
                    <div class="footer-social-wrap">
                        ...
                        <ul class="social-icon color-tertiary md-size justify-content-start">
                            ...
                            <li>
                                <a class="social-icon-link" href="<?php echo esc_url($social['url']); ?>"
                                    title="<?php echo esc_attr($social['label']); ?>" target="_blank" rel="noopener">
        ...
        <div class="footer-container">
            <div class="copyright-row">
                ...
                <div class="copyright-right">
                    <p>&copy; 2022. All rights reserved by <a href="https://themeforest.net/user/axilthemes/portfolio"
                            target="_blank" rel="noopener">Axilthemes.</a></p>
                </div>
            </div>
        </div>
    </div>
